//import { myFunction } from './btn-add-to-cart.js';
                ...
                $(a).click(function() {
                    ...
                    /*
                                                ...
                                                $(".btn-add-to-cart").click(function() {
                                                    ...
                                                    console.log(listCategoryProduct.length + 'so luong product');
                                                    listCategoryProduct.map(function(currentItem, index, arr) {
                                                    ...
                                                    console.log("check list Product :" + listCategoryProduct);
